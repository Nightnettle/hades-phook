        ...
        if (pEntity)
        {
            ...
            if (g_Options.Skinchanger.Enabled)
            {
                ...
                if (pEntity->GetClientClass()->m_ClassID == (int)ClassID::CKnife)
                {
                    ...
                    {
                        int Butterfly = g_ModelInfo->GetModelIndex("models/weapons/v_knife_butterfly.mdl");
                        *pWeapon->ModelIndex() = Butterfly; // m_nModelIndex
                        *pWeapon->ViewModelIndex() = Butterfly;
                        if (worldmodel) *worldmodel->ModelIndex() = Butterfly + 1;
                    ...
                    {
                        int Falchion = g_ModelInfo->GetModelIndex("models/weapons/v_knife_falchion_advanced.mdl");
                        *pWeapon->ModelIndex() = Falchion; // m_nModelIndex
                        *pWeapon->ViewModelIndex() = Falchion;
                        if (worldmodel) *worldmodel->ModelIndex() = Falchion + 1;
                    ...
                    {
                        int Flip = g_ModelInfo->GetModelIndex("models/weapons/v_knife_flip.mdl");
                        *pWeapon->ModelIndex() = Flip; // m_nModelIndex
                        *pWeapon->ViewModelIndex() = Flip;
                        if (worldmodel) *worldmodel->ModelIndex() = Flip + 1;
                        *pWeapon->m_AttributeManager()->m_Item()->ItemDefinitionIndex() = 505;
                        *pWeapon->GetEntityQuality() = 3;
						*pWeapon->FallbackStatTrak() = 69;
                        killIcons.clear();
